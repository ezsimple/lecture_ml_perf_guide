...
# python xgboost wrapper 패키지 로딩하기
...
# 학습용 데이터로 부터, 검증용 데이터를 만드는 과정이 추가 됩니다.
# 위에서 만든 X_train, y_train을 다시 쪼개서 90%는 학습과 10%는 검증용 데이터로 분리
# X_val, y_val 이 검증용 데이터로 사용되는 것을 알 수 있다.
...
# %%
# fit() 호출시 early stopping 을 사용하여 최적의 결과를 찾을 수 있습니다.
# early stopping 을 50으로 설정하고 재 학습/예측/평가 수행
# early stopping 을 사용하면 과적합 방지로 인해 대체로 결과가 좋습니다.
# 검증용 데이터를 사용해야, early stopping을 사용할 수 있습니다.
from xgboost import XGBClassifier
...
# early stopping이 적으면, 오히려 더 않좋은 결과를 얻을 수 있습니다.
